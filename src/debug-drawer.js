    ...
    constructor(program, pixelsPerMeter) {
        ...
        const debugDrawer = Object.assign(new JSDraw(), {
            ...
            DrawSolidPolygon(vertices_p, vertexCount, color_p) {
                ...
                gl.bindBuffer(gl.ARRAY_BUFFER, self.vertPosBuffer);
                gl.vertexAttribPointer(self.aPositionLocation, 2, gl.FLOAT, false, 0, 0);
                gl.enableVertexAttribArray(self.aPositionLocation);
